            ...
            if (veh != null && veh.Exists() && !veh.IsDead)
            {
                ...
                VehicleModMenu.OnCheckboxChange += (sender2, item2, index2, _checked) =>
                {
                    ...
                    else if (item2 == turbo)
                    {
                        ...
                        if (_checked)
                            TriggerServerEvent("LogToDiscord", "vehOptions", $"has **activated** TURBO on a {veh.DisplayName}");
                        else
                            TriggerServerEvent("LogToDiscord", "vehOptions", $"has **deactivated** TURBO on a {veh.DisplayName}");
                    }
                    // Bullet Proof Tires
                    else if (item2 == bulletProofTires)
                    {
                        ...
                        if (_checked)
                            TriggerServerEvent("LogToDiscord", "vehOptions", "has **activated** BULLETPROOF TIRES");
                        else
                            TriggerServerEvent("LogToDiscord", "vehOptions", "has **deactivated** BULLETPROOF TIRES");
                    }
                    // Low Grip Tyres
