        ...
        private void CreateMenu()
        {
            ...
            menu.OnCheckboxChange += (sender, item, index, _checked) =>
            {
                ...
                else if (item == nightVision)
                {
                    ...
                    if (_checked)
                        TriggerServerEvent("LogToDiscord", "staff", "has **activated** Night Vision");
                    else
                        TriggerServerEvent("LogToDiscord", "staff", "has **deactivated** Night Vision");
                }
                else if (item == thermalVision)
                {
                    SetSeethrough(_checked);
                    if (_checked)
                        TriggerServerEvent("LogToDiscord", "staff", "has **activated** Thermal Vision");
                    else
                        TriggerServerEvent("LogToDiscord", "staff", "has **deactivated** Thermal Vision");
                }
